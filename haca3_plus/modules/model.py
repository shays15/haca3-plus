...
class HACA3:
    ...
    def image_to_image_translation(
        ...
        site_ids = image_dicts[0]["site_id"].to(
            self.device
        )
        ...
        if do_inter_site:
            ...
            # --------------------------------------------------
            # Recompute source representations
            #
            # IMPORTANT:
            # intra-site calculate_loss() already performed
    ...
    def train(
        ...
        for epoch in range(
            ...
            for (
                ...
                train_iterator.set_description(desc)
